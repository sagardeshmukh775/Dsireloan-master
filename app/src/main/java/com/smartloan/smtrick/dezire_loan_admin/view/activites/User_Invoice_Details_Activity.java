...
public class User_Invoice_Details_Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
  ...
  Invoice invoice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_invoice_details_activity);
...
//               Toast.makeText(User_Invoice_Details_Activity.this, "Lead Verify Successfully", Toast.LENGTH_SHORT).show();
//                progressDialogClass.dismissDialog();
//
//                Intent i = new Intent(User_Invoice_Details_Activity.this, MainActivity.class);
//                startActivity(i);
//                overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
//            }
//
...
//                progressDialogClass.dismissDialog();
//                Utility.showLongMessage(User_Invoice_Details_Activity.this, getString(R.string.server_error));
//            }
//        });
//    }

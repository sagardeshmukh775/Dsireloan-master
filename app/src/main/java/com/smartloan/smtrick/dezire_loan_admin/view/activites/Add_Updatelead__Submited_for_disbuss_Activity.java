...
public class Add_Updatelead__Submited_for_disbuss_Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btverify.setText("PARTIAL_DISBUSS");
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Toast.makeText(Add_Updatelead__Submited_for_disbuss_Activity.this, "Lead Update Successfully", Toast.LENGTH_SHORT).show();
    ...
    private void updateLeed(String leedId, Map leedsMap) {
        ...
        invoiceRepository.updateLeed(leedId, leedsMap, new CallBack() {
            ...
            public void onSuccess(Object object) {
                ...
                Intent i = new Intent(Add_Updatelead__Submited_for_disbuss_Activity.this, MainActivity.class);
                startActivity(i);
                overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
            }
            ...
            public void onError(Object object) {
                progressDialogClass.dismissDialog();
                Utility.showLongMessage(Add_Updatelead__Submited_for_disbuss_Activity.this, getString(R.string.server_error));
            }
        });
    }

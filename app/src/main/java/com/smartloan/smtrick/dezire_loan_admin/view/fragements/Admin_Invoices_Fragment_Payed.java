...
public class Admin_Invoices_Fragment_Payed extends Fragment {
    ...
    public Admin_Invoices_Fragment_Payed() {
    }
 ...
 //       invoiceArrayList.clear();
        ...
        invoiceRepository.readInvoiceByStatus("PAID",new CallBack(){
            @Override

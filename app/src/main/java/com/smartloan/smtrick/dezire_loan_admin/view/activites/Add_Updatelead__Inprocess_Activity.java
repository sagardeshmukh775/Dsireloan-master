...
public class Add_Updatelead__Inprocess_Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_update_inprocess_activity);
        ...
        btverify.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(Add_Updatelead__Inprocess_Activity.this);
    ...
    private void updateLeed(String leedId, Map leedsMap) {
        ...
        invoiceRepository.updateLeed(leedId, leedsMap, new CallBack() {
            ...
            public void onSuccess(Object object) {
                ...
                Intent i = new Intent(Add_Updatelead__Inprocess_Activity.this, MainActivity.class);
                startActivity(i);
                overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
            }
            ...
            public void onError(Object object) {
                progressDialogClass.dismissDialog();
                Utility.showLongMessage(Add_Updatelead__Inprocess_Activity.this, getString(R.string.server_error));
            }
        });
    }

...
public class Fragment_Generate_homeloan extends RuntimePermissionHelper implements AdapterView.OnItemSelectedListener {
    ...
    public Fragment_Generate_homeloan() {
    }
    ...
    private LeedsModel fillUserModel() {
        ...
        leedsModel.setLoanType("Home Loan");

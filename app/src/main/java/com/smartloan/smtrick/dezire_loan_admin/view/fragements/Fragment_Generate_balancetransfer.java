...
public class Fragment_Generate_balancetransfer extends RuntimePermissionHelper implements AdapterView.OnItemSelectedListener {
    ...
    public Fragment_Generate_balancetransfer() {
    }
    ...
    private LeedsModel fillUserModel() {
        ...
        leedsModel.setLoanType("Balance Transfer Loan");

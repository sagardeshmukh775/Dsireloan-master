...
public class Admin_Invoices_TabFragment extends Fragment {
    private OnFragmentInteractionListener mListener;
    TabLayout tabLayout;
    ViewPager viewPager;
    ViewPagerAdapter viewPagerAdapter;

    public Admin_Invoices_TabFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPagerAdapter.addFragement(new Invoices_Fragment(), "Generated");
        viewPagerAdapter.addFragement(new Invoices_Fragment_Payed(), "Paid");

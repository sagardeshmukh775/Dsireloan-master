...
public class Add_Updatelead__Sanction_Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Button btupdate, btFullDisbuss,btPartDisbuss, btnfail, btnnext,btClose;
    LeedsModel invoice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_update_sanction_activity);
...
//        btFullDisbuss.setText("SUBMIT_FOR_DISBUSS");
    ...
    private void setLeedStatus1(LeedsModel invoice) {
    ...
    private void updateLeed(String leedId, Map leedsMap) {
        ...
        invoiceRepository.updateLeed(leedId, leedsMap, new CallBack() {
            ...
            public void onSuccess(Object object) {
                ...
                Intent i = new Intent(Add_Updatelead__Sanction_Activity.this, MainActivity.class);
                startActivity(i);
                overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
            }
            ...
            public void onError(Object object) {
                progressDialogClass.dismissDialog();
                Utility.showLongMessage(Add_Updatelead__Sanction_Activity.this, getString(R.string.server_error));
            }
        });
    }

...
public class Fragment_Generate_topup extends RuntimePermissionHelper implements AdapterView.OnItemSelectedListener {
    ...
    public Fragment_Generate_topup() {
    }

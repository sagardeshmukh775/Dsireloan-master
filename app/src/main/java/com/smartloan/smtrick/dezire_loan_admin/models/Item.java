...
public class Item {
    ...
    public Item(String price, String pledgePrice, String fromAddress, String toAddress, String requestsCount, String date, String time) {
        this.price = price;
    ...
    public static ArrayList<Item> getTestingList() {
        ...
        items.add(new Item("200000", "$270", "Mr. Pratik Patel", "Status: Loan Approved", "a", "TODAY", "05:10 PM"));
        items.add(new Item("200000", "$116", "Mr. Pratik Patel", "Status: Loan Approved", "", "TODAY", "11:10 AM"));
        items.add(new Item("200000", "$350", "Mr. Pratik Patel", "Status: Loan Approved", "", "TODAY", "07:11 PM"));

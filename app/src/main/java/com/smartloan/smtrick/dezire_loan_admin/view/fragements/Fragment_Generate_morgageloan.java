...
public class Fragment_Generate_morgageloan extends RuntimePermissionHelper implements AdapterView.OnItemSelectedListener {
    ...
    public Fragment_Generate_morgageloan() {
    }
    ...
    private LeedsModel fillUserModel() {
        ...
        leedsModel.setLoanType("Morgage Loan");
